            ...
            IconButton(
              onPressed: () {
                Util.saveImage(
                  widget.illustId,
                  imageOriginalUrls[i],
                  _illustInfoData!.authorDetails.userId,
                );
              },
              splashRadius: 20,
  ...
  Widget _buildDetails() {
    return Container(
      child: ListTile(
        ...
        subtitle: Center(
          child: Text(
            Util.timestampToDateTimeString(
                _illustInfoData!.illustDetails.uploadTimestamp),
            overflow: TextOverflow.ellipsis,
          ),
        ),
      ),
